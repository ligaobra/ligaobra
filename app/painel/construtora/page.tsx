...
export default function PainelConstrutora() {
  return (
    <PainelWrapper>
      <h1 className="text-xl sm:text-2xl font-bold text-green-500 text-center mb-4">Painel da Construtora</h1>

      <div className="space-y-4">
        <p className="text-gray-200">Aqui você gerencia suas vagas e edita seu perfil.</p>
