...
export default function PainelPrestador() {
  return (
    <PainelWrapper>
      <h1 className="text-xl sm:text-2xl font-bold text-green-500 text-center mb-4">Painel do Prestador</h1>

      <div className="space-y-4">
        <p className="text-gray-200">Aqui você pode publicar serviços e editar seu perfil.</p>
